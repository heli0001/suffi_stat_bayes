...
simudata = mclapply(1:3,data_gene,rhoxu1 = 5,rhoxu2 = 5,rhoyu1 = 5,rhoyu2 = 5,m = 500,mc.cores=1)
...
psfunc_suffi = function(dataid,iter=100,burn=0){
  ...
  posteriorfunc=function(param1,param2,prior.mn=0,prior.sd=1){
    ...
    #   }
    # }
    #like = sum(dmultinom(x=x,prob=ps_suffi,log=TRUE))
